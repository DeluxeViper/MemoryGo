 ...
 * This app was created using the **Flutter** framework with **Dart**, and specialized using Android (**Java**) code for the Android app on the Google Playstore (linked below)
